...
public:
    ...
    void setFastRefresh(bool enabled);
    bool isFastRefresh() const { return fastRefresh; }
    ...
    float getLineSpacing() const { return lineSpacing; }
        ...
        // HTML entity decoding - single source of truth
...
private:
    ...
    void drawStatusBarBusyIndicator(LovyanGFX *target);
